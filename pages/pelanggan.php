...
function get_next_no_rm() {
    $.ajax({
        url: 'models/autocomplete.php?method=get_next_no_rm',
        dataType: 'json',
        cache: false,
...
var str = '<div id=form_add>'+
            ...
            '<table width=100% class=data-input>'+
                '<tr><td width=30%>No. RM:</td><td width=70%><?= form_input('norm', NULL, 'id=norm size=40 readonly') ?></td></tr>'+
