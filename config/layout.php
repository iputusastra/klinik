...
/* Tilegroup settings */
$groupTitles = array('Pelayanan','Transaksi','Master Data','Laporan','Analisa'); // titles of the tileGroups
$groupSpacing = array(4,4,4,4,4); // width of each tileGroup (spacing between the groups in tiles)
